...
df <- master_df
df$V6 <- gsub(" ", "_", df$V6)
df$V6 <- paste("chr", df$V6)
df$V6 <- str_replace_all(df$V6, fixed(" "), "")
previous_SJ$intron_ID <- gsub(" ", "_", previous_SJ$intron_ID)
```

```{r}
#Subset
df$previously_reported <- ifelse(df$V6 %in% previous_SJ$intron_ID,"true","false")
...
write_csv(not_in_previousSJ, file = 'not_in_previousSJ.csv')
```

```{r}
#Average spliced to unspliced ratios
df$RRP6_1_YPD_spliced_to_unspliced_ratio_each_sample<- as.numeric(df$RRP6_1_YPD_spliced_to_unspliced_ratio_each_sample)

df$RRP6_2YPD_spliced_to_unspliced_ratio_each_sample <- as.numeric(df$RRP6_2YPD_spliced_to_unspliced_ratio_each_sample)

df$RRP6_3YPD_spliced_to_unspliced_ratio_each_sample <- as.numeric(df$RRP6_3YPD_spliced_to_unspliced_ratio_each_sample)

df$UPF1_1_YPD_spliced_to_unspliced_ratio_each_sample <- as.numeric(df$UPF1_1_YPD_spliced_to_unspliced_ratio_each_sample)

df$UPF1_2YPD_spliced_to_unspliced_ratio_each_sample <- as.numeric(df$UPF1_2YPD_spliced_to_unspliced_ratio_each_sample)

df$UPF1_3YPD_spliced_to_unspliced_ratio_each_sample <- as.numeric(df$UPF1_3YPD_spliced_to_unspliced_ratio_each_sample)

df$U_R_1YPD_spliced_to_unspliced_ratio_each_sample <- as.numeric(df$U_R_1YPD_spliced_to_unspliced_ratio_each_sample)

df$U_R_2YPD_spliced_to_unspliced_ratio_each_sample <- as.numeric(df$U_R_2YPD_spliced_to_unspliced_ratio_each_sample)

df$U_R_3YPD_spliced_to_unspliced_ratio_each_sample <- as.numeric(df$U_R_3YPD_spliced_to_unspliced_ratio_each_sample)

df$WT_1_YPD_spliced_to_unspliced_ratio_each_sample <- as.numeric(df$WT_1_YPD_spliced_to_unspliced_ratio_each_sample)

df$WT_2YPD_spliced_to_unspliced_ratio_each_sample <- as.numeric(df$WT_2YPD_spliced_to_unspliced_ratio_each_sample)

df$WT_3YPD_spliced_to_unspliced_ratio_each_sample <- as.numeric(df$WT_3YPD_spliced_to_unspliced_ratio_each_sample)

df$WT_1_YPD_FAnS <- as.numeric(df$WT_1_YPD_FAnS)

df$WT_2YPD_FAnS <- as.numeric(df$WT_2YPD_FAnS)

df$WT_3YPD_FAnS <- as.numeric(df$WT_3YPD_FAnS)
...
df$RRP6Mean_spliced_to_unspliced <- rowMeans( df[c('RRP6_1_YPD_spliced_to_unspliced_ratio_each_sample', 'RRP6_2YPD_spliced_to_unspliced_ratio_each_sample', 'RRP6_3YPD_spliced_to_unspliced_ratio_each_sample')], na.rm = TRUE)

df$UPF1Mean_spliced_to_unspliced <- rowMeans( df[c('UPF1_1_YPD_spliced_to_unspliced_ratio_each_sample', 'UPF1_2YPD_spliced_to_unspliced_ratio_each_sample', 'UPF1_3YPD_spliced_to_unspliced_ratio_each_sample')], na.rm = TRUE)

df$U_R_Mean_spliced_to_unspliced <- rowMeans( df[c('U_R_1YPD_spliced_to_unspliced_ratio_each_sample', 'U_R_2YPD_spliced_to_unspliced_ratio_each_sample', 'U_R_3YPD_spliced_to_unspliced_ratio_each_sample')], na.rm = TRUE)

df$WTMean_spliced_to_unspliced <- rowMeans( df[c('WT_1_YPD_spliced_to_unspliced_ratio_each_sample', 'WT_2YPD_spliced_to_unspliced_ratio_each_sample', 'WT_3YPD_spliced_to_unspliced_ratio_each_sample')], na.rm = TRUE)
...
df$WT_Mean_FAnS <- rowMeans( df[c('WT_1_YPD_FAnS', 'WT_2YPD_FAnS', 'WT_3YPD_FAnS')], na.rm = TRUE)
...
test_graph <- ggplot(data = df)+
  geom_point(aes(x = as.numeric(U_R_Mean_FAnS), y = as.numeric(UPF1Mean_FAnS), color = U_R_3YPD_overlapping_RPG_annotated_intron, ... = V7))+
  scale_x_log10()+
  scale_y_log10()+
...
test_graph1 <- ggplot(data = df)+
  geom_point(aes(x = as.numeric(U_R_Mean_FAnS), y = as.numeric(RRP6Mean_FAnS), color = U_R_3YPD_overlapping_RPG_annotated_intron, ... = V7))+
  scale_x_log10()+
  scale_y_log10()+
...
test_graph2 <- ggplot(data = df)+
  geom_point(aes(x = as.numeric(RRP6Mean_FAnS), y = as.numeric(UPF1Mean_FAnS), color = U_R_3YPD_overlapping_RPG_annotated_intron, ... = V7))+
  #scale_x_log10()+
  #scale_y_log10()+
...
```{r}
df$wt_to_rrp6_spliced_unspliced <- df$WTMean_spliced_to_unspliced/df$RRP6Mean_spliced_to_unspliced
df$wt_to_upf1_spliced_unspliced <- df$WTMean_spliced_to_unspliced/df$UPF1Mean_spliced_to_unspliced
df$wt_to_u_r_spliced_unspliced <- df$WTMean_spliced_to_unspliced/df$U_R_Mean_spliced_to_unspliced
df$upf1_synergy <- df$wt_to_rrp6_spliced_unspliced * df$wt_to_upf1_spliced_unspliced
```

```{r}
ggplot(data = df)+
  geom_point(aes(x = as.numeric(wt_to_u_r_spliced_unspliced), y = as.numeric(upf1_synergy), color = U_R_3YPD_overlapping_RPG_annotated_intron))+
  scale_x_log10()+
  scale_y_log10()+
  labs(title = "Possible synergy?") +
  xlab("Observed Effect of UPF1∆RRP6∆") +
  ylab("Predicted effect of UPF1∆RRP6∆")+
  labs(colour = "Overlapping RPG annotated intron")+
  geom_abline(slope = 1)

synergy_test <- ggplot(data = df)+
  geom_point(aes(x = as.numeric(wt_to_u_r_spliced_unspliced), y = as.numeric(upf1_synergy), color = U_R_3YPD_overlapping_RPG_annotated_intron, ... = V6))+
  scale_x_log10()+
  scale_y_log10()+
  labs(title = "Possible synergy?") +
  xlab("Observed Effect of UPF1∆RRP6∆") +
