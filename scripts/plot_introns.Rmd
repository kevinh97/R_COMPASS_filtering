...
```{r}
df <- read.delim(file = "/Users/chanfreaulab/Documents/GitHub/R_COMPASS_filtering/R_COMPASS_filtering/merged_compass_datasets/full_upf1_rrp6", sep = "" ,header = TRUE, stringsAsFactors = FALSE)
